  ...
  <div className="bg-primary/60 h-full">
    ...
    to-black/10 ">
      ...
      ">
        ...
        >
         Software Engineer, specialized in full stack Web Development. Well diversified in numerous programming 
          languages and technologies including HTML, CSS, TAILWINDCSS, JS, Node JS, REACTJS, NEXTJS, EXPRESSJS, MONGODB, SQL, MYSQL, Python, JAVA, C/C++,
          Django. 
         </motion.p>
